...
For the rest of this tutorial, we will only write \verb?jutool? for
...
dominance edges as reachability in the tree \todo{ref}.
...
\begin{verbatim}
$ utool solvable -s projects/Domgraph/examples/chain-3.clls
...
\begin{verbatim}
$ utool solve -O term-prolog projects/Domgraph/examples/chain3.clls
...
\begin{verbatim}
$ utool convert projects/Domgraph/examples/rondane-1.mrs.pl -O domcon-oz
%% autogenerated by Domgraph 3.0 (see www.coli.uni-sb.de/projects/chorus/utool for details)
...
\begin{verbatim}
$ utool classify -s projects/Domgraph/examples/rondane-1.mrs.pl
The input graph is normal.
...
\begin{figure}
\begin{center}
\includegraphics[width=0.8\textwidth]{ubench}
\end{center}
...
\begin{verbatim}
$ utool display projects/Domgraph/examples/rondane-1.mrs.pl
\end{verbatim}
%$
