...
192 -- 223 & a semantic error occurred in the input codec \\
...
153 & a parsing error occurred while decoding the USR \\
154 & the input graph is not weakly normal or not compactifiable \\
...
advanced option that is documented in Section~\ref{sec:advanced}.}
\end{itemize}
