...
\begin{enumerate}
\item \citeN{blackburn05:_repres_infer_natur_languag} is a textbook on computational semantics that has a chapter on scope underspecification. They give a very novice-friendly introduction to underspecification in the Hole Semantics framework.
