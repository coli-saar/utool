...
public class FormatManager {
    ...
    private final static Font standardNodeFont = GraphConstants.DEFAULTFONT.deriveFont(Font.PLAIN, 17);
    private final static Font markedNodeFont = GraphConstants.DEFAULTFONT.deriveFont(Font.BOLD, 17);
    ...
    private static Map<Split, String> splitToMarkedHTML = new HashMap<Split, String>();
    private static Map<String, String> subgraphToMarkedHTML = new HashMap<String, String>();
     ...
     */
    public static String getHTMLforMarkedSubgraph(String subgraph) {
