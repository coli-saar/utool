...
import de.saar.chorus.domgraph.layout.treelayout.DomGraphNodeCursor;
 ...
 * <code>DomGraphDrawingCursor</code>.
 * 
 ...
 *
 */
public class SFGraphLayoutCursor extends DomGraphNodeCursor {
		DomGraph graph;
		SFGecodeTreeLayout layout;
		Canvas canvas;
		Set<String> nodes;
		Map<String, String> nodelabels;
		
		/**
		 * Creates a new <code>DomGraphLayoutCursor</code>
		 * 
		 ...
		 */
	    public SFGraphLayoutCursor(String theNode,  Canvas canv, 
	    		SFGecodeTreeLayout theLayout, DomGraph theGraph, Map<String, String> nl) {
		 ...
		 */
	    public SFGraphLayoutCursor(String theNode,  Canvas canv,
	    		SFGecodeTreeLayout theLayout, DomGraph theGraph, 
