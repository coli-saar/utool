...
public class AbstractOptions {
    ...
    private boolean optionComputeRnfs;
...
//    private RewriteSystem rewriteSystem;
    private RelativeNormalFormsComputer rnfComputer;
    private int port;
    ...
    public boolean hasOptionComputeRnfs() {
        return optionComputeRnfs;
    }

    public void setOptionComputeRnfs(boolean optionComputeRnfs) {
        this.optionComputeRnfs = optionComputeRnfs;
    }
    ...
    public RelativeNormalFormsComputer getRnfComputer() {
        return rnfComputer;
    }
