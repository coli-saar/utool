...
public class ChartPresenter {
    public static <E extends GraphBasedNonterminal> String chartOnlyRoots(ConcreteRegularTreeGrammar<E> ch, DomGraph g) {
    ...
    private static <E extends GraphBasedNonterminal> String corSubgraph(E subgraph, ConcreteRegularTreeGrammar<E> ch, Set<String> roots, Set<E> visited) {
    ...
    private static <E extends GraphBasedNonterminal> String corSplit(Split<E> split, Set<String> roots, ConcreteRegularTreeGrammar<E> ch) {
