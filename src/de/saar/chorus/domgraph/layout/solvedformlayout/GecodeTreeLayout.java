...
import de.saar.chorus.domgraph.layout.treelayout.GraphDrawingCursor;
import de.saar.chorus.domgraph.layout.treelayout.GraphLayoutCursor;
...
public class GecodeTreeLayout extends ImprovedJGraphLayout {
	...
	private void placeNodeAt(DefaultGraphCell node, int x, int y, 
		...
		Rectangle bounds =  new Rectangle((int) rect.getX(),
				(int) rect.getY(), (int) graph.computeNodeWidth(node), (int) rect.getHeight());
