 ...
 *
 */
public class SFGraphDrawingCursor extends DomGraphNodeCursor {
	int x;	// the recent x-coordinate
    int y;  // the recent y-coordinate
    
    SFGecodeTreeLayout layout; // the layout object to store 
    						 // the coordinates in
	 ...
	 */
    public SFGraphDrawingCursor(String theNode, 
    		SFGecodeTreeLayout theLayout, DomGraph aGraph) {
	 ...
	 */
    public SFGraphDrawingCursor(String theNode, SFGecodeTreeLayout theLayout, DomGraph aGraph, 
						 Set<String> theNodes) {
