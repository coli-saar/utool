...
class XmlParser extends DefaultHandler {
	...
	public XmlParser(Logger logger, EquationSystem previousEquationSystem, RewriteSystem previousRewriteSystem, Annotator previousAnnotator) {
		super();
	...
	public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
		...
		if( qName.equals("utool") ) {
			...
			if( (attributes.getValue("equations") == null) && (previousEquationSystem != null) ) {
				options.setEquations(previousEquationSystem);
