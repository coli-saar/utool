...
public class IntegerChart {
	...
	private final Map<List<Integer>, List<IntSplit>> chart;
	private final Map<List<Integer>, BigInteger> numSolvedForms;
	private final Map<Integer, List<Integer>> domEdges;

	private final int chainlength;
	private final List<Integer> toplevel;
	...
	public class IntSplit {
		...
		private int root;
        final int leftBoundary, rightBoundary;
